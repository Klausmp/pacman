...
import de.klausmp.pacman.gameObjects.dynamicGameObjects.controler.target.BlinkyGhostTargetControler;
...
public class Blinky extends Ghost {
    ...
    public Blinky(Vector2 position, GridTile gridTile) {
        super(GameScreen.getAtlas().findRegion("blinkyUp1"), position, gridTile, new BlinkyGhostTargetControler());
