...
import de.klausmp.pacman.gameObjects.dynamicGameObjects.controler.movement.PlayerNextRotationChooser;
...
public class PacMan extends Dynamic {
    ...
    public PacMan(Vector2 position, GridTile gridTile) {
        super(GameScreen.getAtlas().findRegion("pacMan0"), position, 100f, Rotation.DEFAULTROTATION, GameObjectType.PACMAN, Layers.FRONT, 5f, gridTile, new PlayerNextRotationChooser(), new DynamicTileMovementControler());
